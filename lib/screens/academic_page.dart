...
class _AcademicPageState extends State<AcademicPage> {
  void _showStudentIdCard() {
    showDialog<void>(
      context: context,
      builder: (context) => Dialog(
        backgroundColor: Colors.transparent,
        child: const _StudentIdCard(),
      ),
    );
  }
...
// ─── Student ID Card Button ─────────────────────────────────────────────────────
class _StudentIdCardButton extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Material(
      color: Colors.transparent,
      child: InkWell(
        onTap: () {
          final state = context.findAncestorStateOfType<_AcademicPageState>();
          state?._showStudentIdCard();
        },
        borderRadius: BorderRadius.circular(24),
        child: Container(
          padding: const EdgeInsets.all(20),
              ...
              children: [
                ...
                Container(
                  ...
                  child: QrImageView(
                    ...
                    foregroundColor: const Color(0xFF082418),
                  ),
                ),
              ],
            ),
